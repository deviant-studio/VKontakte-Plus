...
public object L {
	...
	public fun v(msg: String, vararg formatArgs: Any) {
		if (DEBUG)
			android.util.Log.v(getLocation(), format(msg, *formatArgs))
	}
	
	public fun d(msg: String, vararg formatArgs: Any) {
		if (DEBUG)
			android.util.Log.d(getLocation(), format(msg, *formatArgs))
	}
	
	public fun w(msg: String, vararg formatArgs: Any) {
		if (DEBUG)
			android.util.Log.w(getLocation(), format(msg, *formatArgs))
	}
	
	public fun i(msg: String, vararg formatArgs: Any) {
		if (DEBUG)
			android.util.Log.i(getLocation(), format(msg, *formatArgs))
	}
	
	public fun e(msg: String, vararg formatArgs: Any) {
		if (DEBUG)
			android.util.Log.e(getLocation(), format(msg, *formatArgs))
	}

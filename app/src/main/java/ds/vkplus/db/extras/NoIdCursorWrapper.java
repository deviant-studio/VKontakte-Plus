...
/**
 * A {@link android.database.CursorWrapper} implementation that allows a {@link android.database.Cursor} without a
 * field named "_id" to be used with various Android {@link android.widget.ListView} classes
